...
func (s Server) setupRoutes(e *echo.Echo) {
	...
	e.POST("/api/source/:id/chunks_ready", s.toEchoHandler(datasource2.SourceChunksReadyHandler))
	e.POST("/api/item/:id/chunk", s.toEchoHandler(datasource2.ChunkItemHandler))
